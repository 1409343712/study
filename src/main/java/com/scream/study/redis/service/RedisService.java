package com.scream.study.redis.service;
...
public class RedisService {
     ...
     * @return
     */
    public double hIncrment(String key, String item, double by) {
     ...
     * @return
     */
    public List<Object> lGetBetween(String key, long start, long end) {
        try {
     ...
     * @return
     */
    public Set<Object> zRangeByScore(String key, double beginScore, double endScore) {
        ZSetOperations<String, Object> zset = redisTemplate.opsForZSet();
     ...
     * @param key
     */
    public Set<ZSetOperations.TypedTuple<Object>> zRangeWithScores(String key, long beginIndex, long endIndex) {
        ZSetOperations<String, Object> zset = redisTemplate.opsForZSet();
        Set<ZSetOperations.TypedTuple<Object>> ret = zset.rangeWithScores(key, beginIndex, endIndex);
        return ret;
    }
